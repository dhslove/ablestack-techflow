...
addSlide([
  ...
  textbox("AI Gateway 0.14.6", 88, 518, 404, 52, 26, true, C.white, "center"),
...
addSlide([
  ...header("일반 질의 4,000자와 KB 종합 16,000자를 분리했습니다", 4),
  textbox("오류", 72, 178, 250, 82, 44, true, C.red, "center"),
  textbox("Post #383 선택", 72, 270, 250, 38, 21, true, C.ink, "center"),
  textbox("KB 입력 4,678자\nActivepieces HTTP 500", 72, 342, 250, 92, 21, false, C.gray, "center"),
  ...
  textbox("외부 질문용 4,000자\n계약을 KB에도 재사용", 420, 334, 250, 112, 22, false, C.gray, "center"),
  rect(718, 170, 2, 360, C.rule, "divider-2"),
  textbox("수정", 768, 178, 250, 82, 44, true, C.blue, "center"),
  textbox("계약 분리", 768, 270, 250, 38, 21, true, C.ink, "center"),
  textbox("일반 질의 4,000자\n내부 KB 16,000자\n선택 답변 우선 보존", 768, 334, 250, 112, 21, false, C.gray, "center"),
  rect(1066, 170, 2, 360, C.rule, "divider-3"),
  textbox("#384", 1090, 196, 120, 74, 40, true, C.green, "center"),
  textbox("HTTP 201", 1078, 286, 144, 56, 19, true, C.ink, "center"),
  textbox("231", 1090, 382, 120, 62, 38, true, C.blue, "center"),
  textbox("전체 시험 통과", 1078, 458, 144, 44, 17, false, C.gray, "center"),
], ["docs/reports/issue-69-community-auto-publish-kb-validation.md#3.7", "https://community.ablecloud.io/d/167/384"]);
...
addSlide([
  ...
  textbox("AI Gateway 0.14.6 · OpenAI · 본문과 첨부 제한 분리", 96, 396, 1030, 44, 24, true, C.white),
  textbox("공개 적용 버전: ABLESTACK Diplo · Preview 평가는 내부 전용", 96, 456, 1030, 40, 21, false, "#CBD5E1"),
  textbox("231 tests · Process · Database · Vector ready · 보호 서비스 무변경", 96, 510, 1030, 40, 21, false, "#CBD5E1"),
