...
def main() -> None:
    ...
    if report_pages < 4 or "Issue #69" not in report_text or "Post #368" not in report_text or "최종 솔루션" not in report_text: raise RuntimeError("report PDF contract failed")
