...
def main() -> None:
    ...
    if deck_pages != 5 or slides != 5 or notes != 5 or "Post #368" not in deck_text or "0.14.0" not in deck_text: raise RuntimeError(f"presentation contract failed pages={deck_pages} slides={slides} notes={notes}")
