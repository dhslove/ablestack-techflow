...
class SettingsTest(unittest.TestCase):
    def test_safe_defaults(self) -> None:
        ...
        self.assertEqual(100 * 1024 * 1024 * 1024, settings.artifact_max_extracted_bytes)

    def test_large_upload_boundary_is_bounded(self) -> None:
        Settings(
            artifact_max_bytes=1024 * 1024 * 1024,
            artifact_max_archive_bytes=10 * 1024 * 1024 * 1024,
            artifact_max_extracted_bytes=100 * 1024 * 1024 * 1024,
        ).validate()
        with self.assertRaises(ConfigurationError):
            Settings(
                artifact_max_bytes=1024 * 1024 * 1024 + 1,
                artifact_max_archive_bytes=10 * 1024 * 1024 * 1024,
                artifact_max_extracted_bytes=100 * 1024 * 1024 * 1024,
            ).validate()
        with self.assertRaises(ConfigurationError):
            Settings(
                artifact_max_archive_bytes=10 * 1024 * 1024 * 1024 + 1,
                artifact_max_extracted_bytes=100 * 1024 * 1024 * 1024,
            ).validate()
